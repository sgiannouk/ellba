...
2. For user convenience, we offer the option to run a dedicated test set of Circulating Epithelial Cells derived from [Bahn et al.](https://doi.org/10.1053/j.gastro.2018.09.020). To obtain the required test data, simply navigate to the 'test_data' directory located within the ELLBA docker's home directory and execute the 'download_testdata.py' script. 
```bash
$ cd test_data
